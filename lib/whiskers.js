...
function whiskerSide(ctx, options, flip, droopiness, whiskerSpread) {
  var offset = flip ? -1 : 1;
...
module.exports = function (ctx, options) {
  ...
  whiskerSide(ctx, options, false, droopiness, whiskerSpread);
  whiskerSide(ctx, options, true, droopiness, whiskerSpread);
